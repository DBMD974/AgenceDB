...
class MaConnexion
{
    ...
    public function insertionMedecin_secure($nom, $specialite, $email)
    {
        try {
            // La requête SQL d'insertion est préparée en utilisant des paramètres pour éviter les injections SQL.
            $requete = "INSERT INTO agencedb (Nom, Specialite, email) VALUES (:Nom, :Specialite, :email)";
            ...
            $requete_preparee->bindParam(":Nom", $nom, PDO::PARAM_STR);
            $requete_preparee->bindParam(":Specialite", $specialite, PDO::PARAM_STR);
